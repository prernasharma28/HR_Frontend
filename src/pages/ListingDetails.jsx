...
// Import the necessary date-fns functions
import { startOfDay, startOfWeek, startOfMonth, setYear, setMonth, subMonths, max, min } from 'date-fns';
            ...
            <>
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src = "/path/to/fallback-image.jpg"; // Path to a default fallback image
                }}
              />
              <h3>
